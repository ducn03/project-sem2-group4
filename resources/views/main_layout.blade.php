...
<body>
            ...
            <div class="row">
                <div class="col-md-6 d-flex align-items-center">
                    <p class="mb-0 phone pl-md-2">
                        ...
                        <a href="#"><span class="fa fa-paper-plane mr-1"></span> OrganicFood@email.com</a>
                    </p>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ URL::to('home') }}">Organic <span>food</span></a>
            ...
            <div class="row mb-5">
                <div class="col-sm-12 col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2 logo"><a href="#">Organic <span>Food</span></a></h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <p class="mb-0" style="color: rgba(255,255,255,.5);">
                            ...
                            Copyright &copy;<script>
                                ...
                                href="#" target="_blank">Organic food Team</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
                    ...
                    <div class="container-fluid mt-5">
                        <form method="POST" action="" id="loginForm">
                            ...
                            <div class="form-group text-center pt-2 social-login">
                                ...
                                <a href="" class="google"> <i class="fa fa-google fa-lg"></i> </a>
        ...
        <div class="modal fade" id="registerForm" tabindex="-1" role="dialog" aria-labelledby="registerModal"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content form-wrapper">
                    ...
                    <div class="container-fluid mt-5">
                        <form data-action="" method="POST" id="fromRegister">
                            @csrf
