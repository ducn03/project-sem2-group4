                ...
                <div style="border-radius: 15px;" id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo e(asset('img/carousel1.jpg')); ?>" alt="" style="width:100%; height:348px; border-radius: 15px;">
                        </div>

                        <div class="item">
                            <img src="<?php echo e(asset('img/carousel2.jpg')); ?>" alt="" style="width:100%; height:348px; border-radius: 15px;">
                        </div>

                        <div class="item">
                            <img src="<?php echo e(asset('img/carousel3.jpg')); ?>" alt="" style="width:100%; height:348px; border-radius: 15px;">
                        </div>
                    </div>
